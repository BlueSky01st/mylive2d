...
```xml
<link rel="stylesheet" href="https://testingcf.jsdelivr.net/npm/font-awesome/css/font-awesome.min.css">
```
...
```xml
<script src="https://testingcf.jsdelivr.net/gh/stevenjoezhang/live2d-widget@latest/autoload.js"></script>
```
...
```xml
<script src="https://testingcf.jsdelivr.net/gh/username/live2d-widget@latest/autoload.js"></script>
```
